    ...
    { key: 'reason', title: '理由' },
    {
      ...
      render: (v, row) => (
        <div>
          ...
          {v === 'rejected' && row.rejectReason && (
            <p className="text-xs text-gray-400 mt-1 leading-body">原因：{row.rejectReason}</p>
          )}
        </div>
      ),
    },
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="card-8pt">
          ...
          <p className="text-xs text-gray-400 mt-1 leading-body">
            通过 {approvedCount} &middot; 拒绝 {rejectedCount}
          </p>
        </div>
      </div>
      ...
      >
        {rejectModal.item && (
          <div className="space-y-4">
            {/* Applicant info: p-3(12) gap-3(12) */}
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 leading-body">
                  {rejectModal.item.studentId} &middot; 补卡 {rejectModal.item.cardDate}
                </p>
              </div>
            </div>
            <div>
